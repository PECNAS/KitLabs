    ...
    public partial class Form2 : Form
    {
        public Form2()
        {
            ...
            foreach (var sort in simpleSorts)
            {
                ...
                dataGridView1.Rows.Add("Метод обмена", sort.count, sort.comparisons, sort.permutations, sort.time);
            }
            ...
            foreach (var sort in improvedSorts)
            {
                ...
                dataGridView1.Rows.Add("Метод Шелла", sort.count, sort.comparisons, sort.permutations, sort.time);
            }
